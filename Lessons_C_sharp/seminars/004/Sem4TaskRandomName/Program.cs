...
// Возвращаем кортеж для проверки наличия имени
...
// Это выражение не работает! Почему?
// (bool)names.Item2 ? PrintResult($"Отлично! Выйграл {GetRandomName(names.Item1)}") : PrintResult($"{names.Item1}");
